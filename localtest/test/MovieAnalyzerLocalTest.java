...
public class MovieAnalyzerLocalTest {
  ...
  static void setUp() {
    try {
      ...
      checkDeclarations();
      Constructor<?> constructor = movieAnalyzerClass.getDeclaredConstructor(
        String.class
      );
  ...
  static void checkDeclarations() {
    ...
    for (MethodEntity m : movieAnalyzerMethods) {
      if (!m.checkForClass(movieAnalyzerClass)) {
        errorMessages.add(
          "The method [" + m + "] from class MovieAnalyzer does not exist!"
        );
      }
    }
    assertTrue(
  ...
  <K, V> boolean compareMapWithoutOrder(
    Object obj,
    String expected,
    int question
  ) {
  ...
  void testGetMovieCountByYearWithoutOrder() {
    try {
      ...
      String expected = Files
        .readString(
          Paths.get("resources", "answers_local", "Q1.txt"),
  ...
  void testGetMovieCountByGenreWithoutOrder() {
    try {
      ...
      String expected = Files
        .readString(
          Paths.get("resources", "answers_local", "Q2.txt"),
          StandardCharsets.UTF_8
        )
        .replace("\r", "")
        .strip();
  ...
  void testGetCoStarCount() {
    try {
      ...
      String expected = Files
        .readString(
          Paths.get("resources", "answers_local", "Q3.txt"),
          StandardCharsets.UTF_8
        )
        .replace("\r", "")
        .strip();
  ...
  void testGetTopMoviesRuntimeWithoutOrder() {
    try {
      Method method = movieAnalyzerClass.getMethod(
        "getTopMovies",
        int.class,
        String.class
      );
      ...
      String expected1 = Files
        .readString(
          Paths.get("resources", "answers_local", "Q4_1.txt"),
          StandardCharsets.UTF_8
        )
        .replace("\r", "")
        .strip();
      ...
      String expected2 = Files
        .readString(
          Paths.get("resources", "answers_local", "Q4_2.txt"),
          StandardCharsets.UTF_8
        )
        .replace("\r", "")
        .strip();
      ...
      String expected3 = Files
        .readString(
          Paths.get("resources", "answers_local", "Q4_3.txt"),
          StandardCharsets.UTF_8
        )
        .replace("\r", "")
        .strip();
  ...
  void testGetTopMoviesOverviewWithoutOrder() {
    try {
      ...
      String expected1 = Files
        .readString(
          Paths.get("resources", "answers_local", "Q4_4.txt"),
          StandardCharsets.UTF_8
        )
        .replace("\r", "")
        .strip();
      ...
      String expected2 = Files
        .readString(
          Paths.get("resources", "answers_local", "Q4_5.txt"),
          StandardCharsets.UTF_8
        )
        .replace("\r", "")
        .strip();
      ...
      String expected3 = Files
        .readString(
          Paths.get("resources", "answers_local", "Q4_6.txt"),
          StandardCharsets.UTF_8
        )
        .replace("\r", "")
        .strip();
  ...
  void testGetTopStarsRatingWithoutOrder() {
    try {
      ...
      String expected1 = Files
        .readString(
          Paths.get("resources", "answers_local", "Q5_1.txt"),
          StandardCharsets.UTF_8
        )
        .replace("\r", "")
        .strip();
      ...
      String expected2 = Files
        .readString(
          Paths.get("resources", "answers_local", "Q5_2.txt"),
          StandardCharsets.UTF_8
        )
        .replace("\r", "")
        .strip();
      ...
      String expected3 = Files
        .readString(
          Paths.get("resources", "answers_local", "Q5_3.txt"),
          StandardCharsets.UTF_8
        )
        .replace("\r", "")
        .strip();
  ...
  void testGetTopStarsGrossWithoutOrder() {
    try {
      ...
      String expected1 = Files
        .readString(
          Paths.get("resources", "answers_local", "Q5_4.txt"),
          StandardCharsets.UTF_8
        )
        .replace("\r", "")
        .strip();
      ...
      String expected2 = Files
        .readString(
          Paths.get("resources", "answers_local", "Q5_5.txt"),
          StandardCharsets.UTF_8
        )
        .replace("\r", "")
        .strip();
      ...
      String expected3 = Files
        .readString(
          Paths.get("resources", "answers_local", "Q5_6.txt"),
          StandardCharsets.UTF_8
        )
        .replace("\r", "")
        .strip();
  ...
  void searchMoviesTest() {
    try {
      ...
      String expected1 = Files
        .readString(
          Paths.get("resources", "answers_local", "Q6_1.txt"),
          StandardCharsets.UTF_8
        )
        .replace("\r", "")
        .strip();
      ...
      String expected2 = Files
        .readString(
          Paths.get("resources", "answers_local", "Q6_2.txt"),
          StandardCharsets.UTF_8
        )
        .replace("\r", "")
        .strip();
      ...
      String expected3 = Files
        .readString(
          Paths.get("resources", "answers_local", "Q6_3.txt"),
          StandardCharsets.UTF_8
        )
        .replace("\r", "")
        .strip();
      ...
      String expected4 = Files
        .readString(
          Paths.get("resources", "answers_local", "Q6_4.txt"),
          StandardCharsets.UTF_8
        )
        .replace("\r", "")
        .strip();
      ...
      String expected5 = Files
        .readString(
          Paths.get("resources", "answers_local", "Q6_5.txt"),
          StandardCharsets.UTF_8
        )
        .replace("\r", "")
        .strip();
